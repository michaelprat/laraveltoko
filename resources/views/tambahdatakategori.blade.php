		...
		<div class="row-fluid">
            ...
            <div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white edit"></i><span class="break"></span>Data kategori baru</h2>
					
					</div>
					<div class="box-content">
					{!! Form::open(['route'=>'kategori.store'],array('class'=>"form-horizontal"))!!}		
						  <fieldset>
						...
						<td>	{!! Form::label('nama_kategori','Masukan Nama kategori:',array('class'=>"control-label",'for'=>"typeahead"))!!}	</td> 
