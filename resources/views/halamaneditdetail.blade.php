		...
		<div class="row-fluid">
            ...
            <div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white edit"></i><span class="break"></span>Data detail penjualan baru</h2>
					
					</div>
					<div class="box-content">
					{!! Form::model($data,['route'=>['detail.update',$data->id],'method'=>'put'],array('class'=>"form-horizontal"))!!}			
						  <fieldset>
							<div class="control-group">
								<table width="600px">
							<tr>
								<td>{!! Form::label('id_penjualan','Masukan Id siswa',array('class'=>"control-label",'for'=>"typeahead"))!!}</td>
							 <td>
								<div class="controls">
							        {!! Form::select('id_penjualan',$penjualan,null,array('placeholder'=>"isi tanggal penjualan")) !!}
							  </div>
                               </td>	
							</div>
                            </tr> 
                           <tr>
						   <div class="control-group">
						<td>	{!! Form::label('id_produk','Masukan id produk:',array('class'=>"control-label",'for'=>"typeahead"))!!}	</td> 
						<td>	<div class="controls">
							  {!! Form::select('id_produk',$produk,null,array('placeholder'=>"isi barang")) !!}
							  </div>
                            </td>
							  </div>
							   </tr>
