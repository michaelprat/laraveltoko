		...
		<div class="row-fluid">
            ...
            <div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white edit"></i><span class="break"></span>Data produk baru</h2>
					
					</div>
					<div class="box-content">
					{!! Form::open(['route'=>'produk.store'],array('class'=>"form-horizontal"))!!}		
						  <fieldset>
							<div class="control-group">
								<table width="600px">
							<tr>
								<td>{!! Form::label('nama_produk','Masukan Nama produk',array('class'=>"control-label",'for'=>"typeahead"))!!}</td>
							 <td>
								<div class="controls">
							        {!! Form::text('nama_produk',null,array('placeholder'=>"isi nama produk")) !!}
							  </div>
                               </td>	
							</div>
                            </tr> 
                           <tr>
						   <div class="control-group">
						<td>	{!! Form::label('harga','Masukan Harga:',array('class'=>"control-label",'for'=>"typeahead"))!!}	</td> 
						<td>	<div class="controls">
							  {!! Form::text('harga',null,array('placeholder'=>"isi dengan angka")) !!}
							  </div>
                            </td>
							  </div>
							   </tr>
							...
							<tr>
						   <div class="control-group">
						<td>	{!! Form::label('id_katagori','Masukan kategori:',array('class'=>"control-label",'for'=>"typeahead"))!!}	</td> 
						<td>	<div class="controls">
							 {!! Form::select('id_katagori', $kategori, null, ['placeholder' => 'Pilih katagori...']) !!}
							  </div>
                            </td>
							  </div>
							   </tr>
