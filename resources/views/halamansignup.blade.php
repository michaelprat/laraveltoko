					...
					{!! Form::open(['route' => 'signup.store', 'class' => 'form-horizontal', 'role' => 'form']) !!}	
						<fieldset>
							...
							<div class="input-prepend" title="Firstname">
							 ...
							 {!! Form::text('first_name', null, array('class' => 'input-large span10','placeholder'=>'input firstname')) !!}	
							...
							<div class="input-prepend" title="Lastname">
							 ...
							 {!! Form::text('last_name', null, array('class' => 'input-large span10','placeholder'=>'input lastname')) !!}	
							...
							<div class="clearfix"></div>
										...
										<span class="add-on"><i class="halflings-icon user"></i></span>
													...
													{!! Form::password('password_confirmation', null, array('class' => 'input-large span10','placeholder'=>'confirm password')) !!}	
