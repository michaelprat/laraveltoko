		...
		<div class="row-fluid">
            ...
            <div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white edit"></i><span class="break"></span>Edit data pelanggan</h2>
					
					</div>
					<div class="box-content">
                    {!! Form::model($data,['route'=>['pelanggan.update',$data->id],'method'=>'put'],array('class'=>"form-horizontal"))!!}		
						  <fieldset>
                          <div class="control-group">
						   ...
						   <div class="control-group">
						<td>	{!! Form::label('nama_pelanggan','Masukan Nama pelanggan:',array('class'=>"control-label",'for'=>"typeahead"))!!}	</td> 
						<td>	<div class="controls">
							  {!! Form::text('nama_pelanggan',null,array('placeholder'=>"isi nama pelanggan")) !!}
							  </div>
                            </td>
							  </div>
							   </tr>
