		...
		<div class="row-fluid">
            ...
            <div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white edit"></i><span class="break"></span>Edit kategori</h2>
					
					</div>
					<div class="box-content">
                    {!! Form::model($data,['route'=>['kategori.update',$data->id],'method'=>'put'],array('class'=>"form-horizontal"))!!}		
						  <fieldset>
                        
								<table width="600px">
							<tr>
						   <div class="control-group">
						<td>	{!! Form::label('nama_kategori','Masukan Nama Katagori:',array('class'=>"control-label",'for'=>"typeahead"))!!}	</td> 
						<td>	<div class="controls">
							  {!! Form::text('nama_kategori',null,array('placeholder'=>"isi nama kategori")) !!}
							  </div>
                            </td>
							  </div>
							   </tr>
