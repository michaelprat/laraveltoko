		...
		<div class="row-fluid">
            ...
            <div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white edit"></i><span class="break"></span>Data penjualan baru</h2>
					
					</div>
					<div class="box-content">
					{!! Form::model($data,['route'=>['penjualan.update',$data->id],'method'=>'put'],array('class'=>"form-horizontal"))!!}		
						  <fieldset>
							<div class="control-group">
								...
								<tr>
						   <div class="control-group">
						<td>	{!! Form::label('id_pelanggan','Masukan nama pelanggan:',array('class'=>"control-label",'for'=>"typeahead"))!!}	</td> 
						<td>	<div class="controls">
							 {!! Form::select('id_pelanggan', $pelanggan, null, ['placeholder' => 'Pilih nama konsumen']) !!}
							  </div>
                            </td>
							  </div>
							   </tr>
	                        ...
	                        <tr>
							<div class="control-group">
							<td>  <label class="control-label" for="date01">Tanggal beli</label></td>
							<td>  
							<div class="controls">
							{!! Form::date('tanggal_beli', \Carbon\Carbon::now()); !!}	{{--<input type="text" class="input-xlarge datepicker" id="date01" value="02/16/12">--}}
							  </div>
                               </td>
							</div>
                            </tr>
